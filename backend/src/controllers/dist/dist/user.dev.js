...
function () {
  function UserController() {
    ...
    this.searchUser = function (req, res, next) {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , solvedacService_js_1["default"].searchUsers(query)];
            ...
            case 1:
              ...
              searchResult = items.slice(0, Math.min(count, 10)).map(function (item) {
                return [item.handle, item.tier];
              });
              return [2
              /*return*/
              , res.status(200).json({
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 1:
              ...
              if (!((existingUser === null || existingUser === void 0 ? void 0 : existingUser.level) === 0)) return [3
              /*break*/
              , 6];
              _d.label = 2;
            ...
            case 6:
              if (!!existingUser) return [3
              /*break*/
              , 20];
              if (isUserPage) return [2
              /*return*/
              , res.status(400).json(" 요청입니다.")];
              return [4
              /*yield*/
              , Promise.all([solvedacService_js_1["default"].getUserInfo(userId), solvedacService_js_1["default"].getUserProblemAll(userId, 1)])];
            ...
            case 8:
              if (!(i <= totalPages)) return [3
              /*break*/
              , 16];
              return [4
              /*yield*/
              , solvedacService_js_1["default"].getUserProblemAll(userId, i)];
            ...
            case 11:
              ...
              /*break*/
              , 13];
              problemTags = item.tags ? item.tags.map(function (tag) {
                var _a, _b;

                return (_b = (_a = tag.displayNames) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.name;
              }).filter(Boolean) : [];
              return [4
              /*yield*/
              , problem_js_1["default"].create({
                bojId: item.problemId,
                title: item.titleKo,
                level: item.level,
            ...
            case 19:
              ...
              if (saveError_1.name === "ValidationError") {
                ...
                , res.status(400).json({
                  ...
                  errors: Object.values(saveError_1.errors).map(function (err) {
                    return err.message;
                  })
                })];
              }
